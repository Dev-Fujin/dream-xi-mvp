...
export function simulateCampaign(stats: TeamStats, ownSquadIds: string[] = []): Campaign {
  ...
  for (const item of tournamentPhases) {
    ...
    matches.push({
      ...
      opponentFlag: opponent.flagCode,
